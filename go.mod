...
require (
	buf.build/gen/go/safedep/api/grpc/go v1.6.2-20260722054803-f24d8ff61049.1
	buf.build/gen/go/safedep/api/protocolbuffers/go v1.36.11-20260722054803-f24d8ff61049.1
