...
// ValidateSystemInstall re-runs the checks on every object of the system
// install, for `pmg setup doctor`.
func ValidateSystemInstall() error {
	return validateSystemInstall(SystemBinDir())
}
