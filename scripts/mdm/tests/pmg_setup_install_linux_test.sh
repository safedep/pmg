...
INSTALL_SOURCE="${SCRIPT_DIR}/linux/pmg_setup_install_linux.sh"
LIB_SOURCE="${SCRIPT_DIR}/linux/lib_linux.sh"
...
STARTUP_CREDENTIALS_FILE="${TEST_ROOT}/startup-credentials"
FAKE_PMG="${TEST_ROOT}/pmg"
