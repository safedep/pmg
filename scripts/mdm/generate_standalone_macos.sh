...
STANDALONE_LIB_SOURCE="${SCRIPT_DIR}/lib_macos.sh"
STANDALONE_INSTALL_SOURCE="${SCRIPT_DIR}/pmg_setup_install_macos.sh"
STANDALONE_UNINSTALL_SOURCE="${SCRIPT_DIR}/pmg_uninstall_macos.sh"
