...
STANDALONE_LIB_SOURCE="${SCRIPT_DIR}/lib_linux.sh"
STANDALONE_INSTALL_SOURCE="${SCRIPT_DIR}/pmg_setup_install_linux.sh"
STANDALONE_UNINSTALL_SOURCE="${SCRIPT_DIR}/pmg_uninstall_linux.sh"
...
# shellcheck source=generate_standalone_lib.sh
source "${SCRIPT_DIR}/generate_standalone_lib.sh"
